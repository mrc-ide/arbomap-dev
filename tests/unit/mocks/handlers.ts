...
export const handlers: HttpHandler[] = [
    ...
    http.get(`resources/indicators/indicators-TZA-ADM1.json`, () =>
        HttpResponse.json(MOCK_ADMIN1_INDICATORS.TZA)
    ),
    http.get(`resources/indicators/indicators-TZA-ADM2.json`, () =>
        HttpResponse.json(MOCK_ADMIN2_INDICATORS.TZA)
    ),
    http.get(`resources/indicators/indicators-MWI-ADM2.json`, () =>
