...
export const handlers: HttpHandler[] = [
    ...
    http.get(`${resourcesBase}/indicators/indicators-MWI-ADM1.json`, () =>
        HttpResponse.json(MOCK_ADMIN1_INDICATORS.MWI)
    ),
    http.get(`${resourcesBase}/indicators/indicators-TZA-ADM1.json`, () =>
        HttpResponse.json(MOCK_ADMIN1_INDICATORS.TZA)
    ),
    http.get(`${resourcesBase}/indicators/indicators-TZA-ADM2.json`, () =>
        HttpResponse.json(MOCK_ADMIN2_INDICATORS.TZA)
    ),
    http.get(`${resourcesBase}/indicators/indicators-MWI-ADM2.json`, () =>
