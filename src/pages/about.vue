<template>
    <!-- Light theme for this page so that the logo images have enough contrast to be legible -->
            ...
            <v-col>
                <v-row>
                    ...
                    <ul class="text-body-1">
                        <li>
                            The average dengue force of infection (i.e. the per capita annual risk of dengue infection
